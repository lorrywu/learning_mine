...
mnist = datasets.MNIST(
    root='/Users/lorry/Documents/python/pytorch_learn_be/my_data/MNIST', train=True, transform=img_transform, download=True)
# Data loader
...
class discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 3, 5, padding=2),  # batch, 32, 28, 28
            nn.LeakyReLU(0.2, True),
            nn.AvgPool2d(2, stride=2),  # batch, 32, 14, 14
            )
        self.conv2 = nn.Sequential(
            nn.Conv2d(3, 64, 5, padding=2),  # batch, 64, 14, 14
            nn.LeakyReLU(0.2, True),
